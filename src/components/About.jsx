  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className='relative hidden tablet:block' >
        ...
        <div className="tablet:pl-28 mobile:pl-2 tablet:ml-32  text-mainText tracking-wide font-normal text-xl  tablet:text-lg  mobile:font-thin dark:text-darkThemeText">
        <h2 className="text-mainText tracking-wider font-semibold text-xl lg:text-[40px] dark:text-darkThemeText">О наc</h2>
          ...
          <ScrollSlider />
          <div className="flex tablet:gap-10 mobile:gap-2 pb-24 mt-12">
            ...
            <Button className="block tablet:hidden text-main text-sm tracking-wide pl-0 hover:underline hover:text-decoration-solid dark:text-darkThemeText">Почитать о нашей команде</Button>
