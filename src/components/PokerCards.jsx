...
const PokerCards = () => {
    ...
    return (
      <div className="flex flex-col tablet:flex-row justify-around tracking-wide container place-content-center align-center mt-4 tablet:mt-8 laptop:mt-10 pb-5 tablet:pb-24 laptop:pb-64">
